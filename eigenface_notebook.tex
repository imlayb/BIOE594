...
The eigenface rawdata and metadata is packaged with this repository and
can be loaded with the following code. Try executing this chunk by
clicking the \emph{Run} button within the chunk or by placing your
